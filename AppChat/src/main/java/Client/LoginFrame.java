...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lb_status.setBackground(new java.awt.Color(204, 204, 255));
        lb_status.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lb_status.setText("You are not connected to server");

        jMenu1.setText("User");

        mi_sign_in.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        mi_sign_in.setText("Sign In");
        jMenu1.add(mi_sign_in);

        mi_sign_out.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_D, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lb_status, javax.swing.GroupLayout.DEFAULT_SIZE, 371, Short.MAX_VALUE))
                .addGap(13, 13, 13))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(myPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(lb_status, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    class myClientListListener implements ClientListListener {
        public void addToList(String usersName) {
            if (!usersName.equalsIgnoreCase(userName)) {
                ...
                int opcion = JOptionPane.showConfirmDialog(null, "There is a new connection, do you want to chat??");
                // 0:yes, 1:no. 2:cancel
                if (opcion == 1) {
                    buddyList.list_model.removeElement(usersName);
                }
            }
        }
    ...
    class MyClientWindowListener implements ClientWindowListener {
        ...
        public void closeWindow(String getMessage) {
            ...
            messagingFrames[messagingFrameNo].setVisible(false);
